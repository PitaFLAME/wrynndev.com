  ...
  return (
    ...
    <div className="relative overflow-x-hidden">
      ...
      <div className="relative flex flex-col items-center w-full bg-[#131415] z-10 py-[20vh]" ref={navTrigger}>
        ...
        <div className="w-4/5">
          <h3 className="font-ysabeau text-6xl text-center">We Are WrynnDev</h3>
          <p className="font-montserrat font-thin text-4xl text-[#e2e3e4] leading-snug mt-[4vh]">
          ...
          <svg className="mt-[12vh] scale-75 fill-[#262830]"
          ...
          <p className="font-montserrat font-thin text-4xl text-[#e2e3e4] text-center leading-snug mt-[4vh]">
          ...
          <svg className="w-[5%] mx-auto mt-[8vh] fill-[#e2e3e4]/40" viewBox="0 0 176.23 176.23">
          ...
          <div className="w-2/3 mx-auto mt-[16vh]">
            <p className="font-montserrat text-3xl text-[#e2e3e4] text-center">
            ...
            <p className="font-montserrat text-3xl text-[#e2e3e4] text-center mt-[2vh]">
