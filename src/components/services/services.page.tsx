    ...
    <div className="relative overflow-x-hidden">
      ...
      <div className="relative flex flex-col items-center w-full bg-[#131415] z-10 py-[20vh]" ref={navTrigger}>
        ...
        <div className="flex flex-col w-1/2 h-1/2 font-montserrat text-center text-[#e2e3e4]">
          <h2 className="w-full font-bold text-[2.2rem] leading-10">PARTNERSHIP, NOT JUST A PRODUCT</h2>
          <p className="w-full text-4xl leading-[1.2] font-light pt-10">Most web developers build your site, hand you the keys, and disappear. We do things differently. 
        ...
        <div className="flex flex-row mt-[20vh]">
          ...
          <div className="w-[20vw] pb-[8vh] pt-[4vh] mx-4 bg-gradient-to-br transition-all duration-200 from-[#111213] to-[#101112] border border-[#080808] hover:from-[#202224] hover:to-[#212325] hover:border-[#e2e3e4]">
        ...
        <div className="mt-[12vh] py-[12vh] bg-[#101112]">
          <div>
            <h3 className="font-montserrat font-bold text-6xl text-center leading-tight">PROFESSIONAL WEBSITES<br/>WITHOUT THE STICKER SHOCK</h3>
            <div className="grid grid-cols-2 mt-[8vh]">
              <div className="">
                <Image
              ...
              <div className="relative">
                <p className="font-montserrat font-thin text-5xl w-4/5 mt-12 leading-snug px-8">
                ...
                <a className="absolute flex justify-center items-center border-2 border-white w-2/3 ml-[5vw] py-[2vh] bottom-[4vh] cursor-pointer transition-colors duration-100 hover:bg-[#e2e3e4]/10 active:bg-[#e2e3e4]/30" href="./contact">
